...
export declare type DataDetectors =
  | 'PKDataDetectorTypePhoneNumber'
  | 'PKDataDetectorTypeLink'
  | 'PKDataDetectorTypeAddress'
  | 'PKDataDetectorTypeCalendarEvent';
export declare type DataStyleFormat =
  | 'PKDateStyleNone'
  | 'PKDateStyleShort'
  | 'PKDateStyleMedium'
  | 'PKDateStyleLong'
...
export declare type NumberStyle =
 ...
 */
export declare type TransitType =
  | 'PKTransitTypeAir'
  | 'PKTransitTypeBoat'
  | 'PKTransitTypeBus'
  | 'PKTransitTypeTrain'
...
export declare type PassStructureFields =
  | BoardingPass
  | CouponPass
  | EventTicketPass
  | GenericPass
  | StoreCardPass;
export declare type ApplePass = PassStandardKeys &
